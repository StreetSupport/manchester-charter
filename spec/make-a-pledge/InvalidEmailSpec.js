...
describe('Make a Pledge - Invalid Email', () => {
  ...
  beforeEach(() => {
    ...
    browserGetInputFieldStub.withArgs('email').returns('invalidemail.com')
  ...
  it('should tell browser to show error', () => {
    expect(browserShowErrorStub.withArgs('email', 'Email is not valid.').calledOnce).toBeTruthy()
  })
})
