...
describe('Join An Action Group - No Message', () => {
  ...
  beforeEach(() => {
    ...
    browserGetInputFieldStub.withArgs('message').returns('')
  ...
  it('should tell browser to show error', () => {
    expect(browserShowErrorStub.withArgs('message', 'Message should not be empty.').calledOnce).toBeTruthy()
  })
})
