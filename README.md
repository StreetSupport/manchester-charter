...
* Run: `npm i` (if you receive errors pertaining to snyk - most likely on Windows - follow [these instructions](https://support.snyk.io/snyk-cli/snyk-protect-requires-the-patch-binary).
